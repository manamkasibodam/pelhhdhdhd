...
به ربات ما امتیاز بدید  👈        [⭐️PvResan⭐️](https://telegram.me/storebot?start=pvresansazrobot)

🔹هر نفر = یک ربات ✖️
🔸ربات دوم = 5000ت ✔️
🤖 @PvResansazroBot',"parse_mode"=>"MARKDOWN","disable_web_page_preview"=>"true"));
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://pvresanbot-hamechi.rhcloud.com/'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://pvresanbot-hamechi.rhcloud.com/'.$chat_id.'/pvresan.php');
